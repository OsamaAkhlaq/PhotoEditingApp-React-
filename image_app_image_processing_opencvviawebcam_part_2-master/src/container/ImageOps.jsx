                ...
                <Grid item xs={6}>
                   <Card>
                        <CardContent>
                            ...
                            <Image sign_url={true} publicId="37982644_227483941301117_4819177073908121600_n.jpg_oigdjr" cloudName="dzzabfnpk" >
                            </Image>
                        </CardContent>
                   </Card>
                </Grid>
                <Grid item xs={6}>
                    <Card>
                        <CardContent>
                            ...
                            <Image publicId="37982644_227483941301117_4819177073908121600_n.jpg_oigdjr" cloudName="dzzabfnpk" >
                    ...
                    <Grid xs={12}>
                        <Card item xs={6}>
                            ...
                            <Box color="text.primary">
                              ...
                              <Button variant="contained" align="left" onClick={() => this.createAdvanceEffects("blackwhite")} >
                                  Black & White
                              </Button>
                              ...
                              <Button variant="contained" align="left" onClick={() => this.createAdvanceEffects("brightness")} >
                                  brightness
                              </Button>
                              ...
                              <Button variant="contained" align="left" onClick={() => this.createAdvanceEffects("negate")} >
                                  negate
                              </Button>

                              <Button variant="contained" align="left" onClick={() => this.createAdvanceEffects("outline")} >
                                  outline
                              </Button>

                              <Button variant="contained" align="left" onClick={() => this.createAdvanceEffects("tint")} >
                                  tint
                              </Button>

                              <Button variant="contained" align="left" onClick={() => this.resetFilters(["tint", "outline", "vignette", "cartoonify", "blackwhite", "vibrance", "oil_paint", "negate", "brightness"])} color="primary">
                                  Reset
                              </Button>
